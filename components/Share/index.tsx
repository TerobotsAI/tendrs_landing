    ...
    <>
      <div className="dark" id="waitlist-form">
        <div className="relative min-h-screen overflow-hidden bg-purple-800 dark:text-gray-100 after:w-full after:absolute after:bottom-0 after:h-px after:bg-radial-border">
          ...
          <div className="relative container my-auto xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-40 pb-10">
            <div className="md:text-center z-100">
              <Link
                href="/"
              ...
              <h1 className="text-3xl lg:text-5xl my-9 leading-tight lg:leading-normal font-black text-white mb-4">
                🎉 Thank You for Joining Tendrs! 🎉
              </h1>
              <h2 className="text-base md:text-lg max-w-4xl mx-auto text-white/70 my-5">
                You&apos;re now on the waitlist for tendrs.ai. But wait,
                there&apos;s more! Sharing the excitement with your network can
                earn you additional credits and even lifetime free access!
                Invite others to join you on this journey to success, and
                together, we&apos;ll revolutionize the way businesses connect
                and grow.
              </h2>
            </div>
            ...
            <div className="mx-auto w-full text-center">
              <Link
                href="/"
                type="button"
                className="inline-flex justify-center items-center space-x-2 focus:border font-semibold rounded-lg px-5 py-3 leading-5 text-sm focus:border-white/70 bg-transparent text-white mx-auto"
              >
