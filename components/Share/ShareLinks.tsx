      ...
      <div className="flex flex-wrap w-full md:w-max items-center justify-center gap-8 rounded-xl border-2 text-center px-4 md:px-10 py-8 mx-auto bg-white/5 backdrop-blur-sm dark:border-white/20 ">
        ...
        >
          <svg
            ...
            className="w-8 h-8 mx-auto transition hover:text-green-500 focus-within:scale-95"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            strokeWidth="2"
        ...
        <Link
          target="_blank"
          href="https://www.linkedin.com/sharing/share-offsite/?url=tendrs.ai"
          className="space-y-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          target="_blank"
          href="https://www.facebook.com/login.php?skip_api_login=1&signed_next=1&next=https://www.facebook.com/v11.0/dialog/share?display=popup&href=https://www.tendrs.ai"
          className="space-y-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <h3 className="font-medium">Twiiter</h3>
        </Link>
        <button
          onClick={() => {
        ...
        >
          ...
          <h3 className="font-medium">Copy Link</h3>
        </button>
      </div>
    </>
  )
