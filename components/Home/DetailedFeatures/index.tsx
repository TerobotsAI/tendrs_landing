...
const features = [
  {
    ...
    caption: 'in-house ai',
    title:
      ' AI-Driven meetings with ideal clients and vendors all over the world',
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Experience the convenience of connecting with potential partners at any time of the day, any day of the year, thanks to AI',
    ...
    features: [
      {
        ...
        description:
          'Protect your network from irrelevant and spammy connections, allowing you to focus on building meaningful relationships',
      ...
      },
      {
        ...
        description:
          'Create a genuine networking environment where interactions are based on relevance and mutual goals, fostering authenticity.',
    ...
    features: [
      {
        ...
        description:
          'Connect with like-minded professionals who share your values and objectives, ensuring that your networking interactions are meaningful and productive.',
        icon: IconHeartHandshake
      },
      {
        id: 6,
        ...
        description:
          'Build genuine relationships with people who share your interests, allowing you to create a network of trusted partners.',
        icon: IconShieldCheck
      }
    ]
  }
