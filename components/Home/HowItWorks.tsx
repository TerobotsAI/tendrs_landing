...
const data = [
  {
    ...
    description: 'Create your account and get started with our platform. It\'s easy and quick to set up, so you can begin connecting with potential clients and vendors right away.',
  },
  {
    id: 2,
    ...
    description: 'Tell us what you are looking for or what you have to offer. Input your specific requirements or offerings, and our AI model will find the best matches for you.',
  },
  {
    id: 3,
    ...
    description: 'AI handles matching & auto-schedules meetings. Connect effortlessly with clients & vendors.',
  }
]
