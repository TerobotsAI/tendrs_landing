...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className='relative overflow-hidden text-gray-100 bg-slate-950 after:w-full after:absolute after:bottom-0 after:h-px after:bg-radial-border'>
        {/* Main Header */}
        <header
          id='page-header'
          ...
          <div className='flex text-center items-center justify-between container xl:max-w-7xl mx-auto px-4 lg:px-8'>
            ...
            <div className='flex items-center gap-6'>
              ...
              {/* Navigation */}
              <nav className='hidden lg:block space-x-3 md:space-x-6'>
                {menuItems.map((item) => (
                  <a
                    key={item.name}
                    href={item.url}
