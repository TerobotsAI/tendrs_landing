  ...
  return (
    <>
      <div
        ...
        className='flex-1 group p-5 xl:p-6 transition ease-out duration-200 rounded-2xl text-center hover:bg-purple-50 dark:hover:bg-purple-800/25 backdrop-blur-xl '>
